defmodule TreeDbProfiler.PortfolioStateTest do
  use ExUnit.Case, async: true

  alias TreeDbProfiler.{Fixtures, PortfolioState}

  test "tracks portfolio repositories, workspaces, and growth counters" do
    root =
      Path.join(System.tmp_dir!(), "treedb-profiler-state-#{System.unique_integer([:positive])}")
