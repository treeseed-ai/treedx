...
// Compatibility entrypoint for the restored release-gate workflow, which runs
// this script without installing TypeScript tooling in the Rust SDK job.
...
function extractOperations() {
  ...
  for (const line of lines) {
    ...
    if (
      currentPath &&
      methodMatch &&
      methodMatch[1].length > currentPathIndent &&
      methodNames.has(methodMatch[2])
    ) {
