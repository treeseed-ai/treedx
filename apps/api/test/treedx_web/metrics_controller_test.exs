defmodule TreeDxWeb.MetricsControllerTest do
  ...
  test "records auth failures and capability denials" do
    ...
    assert Enum.any?(metrics.counters, &(&1.name == "treedx_auth_failures_total"))
    assert Enum.any?(metrics.counters, &(&1.name == "treedx_capability_denials_total"))
  end
end
