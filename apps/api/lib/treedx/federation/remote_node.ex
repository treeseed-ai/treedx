defmodule TreeDx.Federation.RemoteNode do
  @moduledoc false
  ...
  defp remote_enabled? do
    if System.get_env("TREEDX_FEDERATION_ENABLE_REMOTE_HTTP", "true") in ["false", "0"] do
      :disabled
    else
      :ok
    end
  ...
  defp timeout(params) do
    requested = params["timeoutMs"] || System.get_env("TREEDX_FEDERATION_HTTP_TIMEOUT_MS")
  ...
  defp forward_auth?,
    do: System.get_env("TREEDX_FEDERATION_FORWARD_AUTH", "true") not in ["false", "0"]
end
