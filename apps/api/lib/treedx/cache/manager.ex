defmodule TreeDx.Cache.Manager do
  @moduledoc false
  use GenServer

  alias TreeDx.{Cache, Observability.Metrics}
  alias TreeDx.Runtime.Resources

  @managed [
    {TreeDx.RepositoryCache, :repo_doc},
    {TreeDx.Graph.IndexCache, :graph_index}
  ]
  ...
  defp publish_runtime do
    ...
    Metrics.put_gauge("treedx_runtime_cpu_budget", Resources.cpu_budget())
    Metrics.put_gauge("treedx_runtime_beam_memory_bytes", snapshot.beam_total_bytes)
    Metrics.put_gauge("treedx_runtime_ets_memory_bytes", snapshot.ets_bytes)
    Metrics.put_gauge("treedx_runtime_binary_memory_bytes", snapshot.binary_bytes)
    Metrics.put_gauge("treedx_runtime_process_memory_bytes", snapshot.process_bytes)
  ...
  defp schedule_sample do
    interval = Resources.int_env("TREEDX_CACHE_SAMPLING_INTERVAL_MS", 1_000)
