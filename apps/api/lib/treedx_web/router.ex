defmodule TreeDxWeb.Router do
  ...
  scope "/api/v1", TreeDxWeb do
    ...
    post("/repos/:repo_id/refs/promote", PushController, :promote)
    post("/repos/:repo_id/refs/retire", PushController, :retire)
    post("/repos/:repo_id/refs/discard-orphan", PushController, :discard_orphan)
    ...
    post("/workspaces/:workspace_id/abandon", WorkspaceController, :abandon)
