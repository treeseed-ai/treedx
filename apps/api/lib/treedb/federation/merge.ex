defmodule TreeDb.Federation.Merge do
  @moduledoc false
  ...
  defp qualify_id("treedb://repo/" <> _ = id, _repo_id, _kind), do: id

  defp qualify_id(id, repo_id, kind) when is_binary(id),
    do: "treedb://repo/#{repo_id}/#{kind}/#{id}"

  defp qualify_id(id, repo_id, kind), do: "treedb://repo/#{repo_id}/#{kind}/#{inspect(id)}"
  ...
  defp repo_from_qualified("treedb://repo/" <> rest),
